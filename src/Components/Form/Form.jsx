                    ...
                    {carts.length <= 0 ? (
                        ...
                        <div className={cx('wrapper-item')}>
                            {carts.map((cart, index) => (
                                <div className={cx('item-customer')} key={index} onClick={() => handleClickInfo(index)}>
                                    <div className={cx('name-customer')}>{cart.name}</div>
                                    <div className={cx('product')}>{cart.nameProduct}</div>
                                    <div className={cx('address')}>{cart.address}</div>
                                    <div className={cx('time')}>{cart.time}</div>
                                    <FontAwesomeIcon
                                        icon={faTrash}
                                        className={cx('icon')}
